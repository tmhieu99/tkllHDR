...
HD_PWD='C:/Users/dangn/Dropbox/it/CodingSpace/tkllHTR/build/tkllHTR.runs/tkllHTR_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tkllHTR_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tkllHTR_xbar_0.tcl
