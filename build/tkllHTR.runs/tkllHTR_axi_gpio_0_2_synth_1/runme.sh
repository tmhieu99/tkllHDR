...
HD_PWD='C:/Users/dangn/Dropbox/it/CodingSpace/tkllHTR/build/tkllHTR.runs/tkllHTR_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tkllHTR_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tkllHTR_axi_gpio_0_2.tcl
