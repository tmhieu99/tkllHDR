...
HD_PWD='C:/Users/dangn/Dropbox/it/CodingSpace/tkllHTR/build/tkllHTR/tkllHTR.runs/tkllHTR_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tkllHTR_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tkllHTR_axi_gpio_0_0.tcl
