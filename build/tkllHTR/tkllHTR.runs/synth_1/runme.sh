...
HD_PWD='C:/Users/dangn/Dropbox/it/CodingSpace/tkllHTR/build/tkllHTR/tkllHTR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tkllHTR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tkllHTR_wrapper.tcl
