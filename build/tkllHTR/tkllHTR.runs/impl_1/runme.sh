...
HD_PWD='C:/Users/dangn/Dropbox/it/CodingSpace/tkllHTR/build/tkllHTR/tkllHTR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tkllHTR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tkllHTR_wrapper.tcl -notrace
